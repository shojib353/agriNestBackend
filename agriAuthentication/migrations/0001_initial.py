# Generated by Django 5.2.12 on 2026-03-08 03:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('buyer', 'Buyer'), ('seller', 'Seller'), ('driver', 'Driver'), ('admin', 'Admin')], default='buyer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('driver_type', models.CharField(choices=[('truck', 'Truck'), ('tractor', 'Tractor')], max_length=20)),
                ('base_location', models.CharField(max_length=255)),
                ('rate_per_job', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
